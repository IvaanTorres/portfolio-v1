...
class ProjectSeeder extends Seeder
{
    ...
    public function run()
    {
        /* $travel_agency = new Project('Travel Agency', '', 'https://github.com/IvaanTorres/daw-travel-agency', 1, 1);
...
Achivement: I learned how to use Java on desktop apps. Also I learned how to load content dynamically using MySQL with it.";
        $todo_app = new Project('TO-DO App', '', 'https://github.com/IvaanTorres/todo-app', 1, 0);
...
Moreover, I got the idea of using types on VueJS thanks to TypeScript.";
        $sass_framework = new Project('CSS Framework', '', 'https://github.com/IvaanTorres/css-framework', 1, 1);
...
Also, I appreciate the use of BEM for CSS classes. I already know how to name them without making a mess.";
        $php_vanilla_framework = new Project('PHP Framework', '', 'https://github.com/IvaanTorres/php-framework', 1, 0);
...
Also, thanks to it, Laravel wasn't that complicated to learn due to the fact I created a complete framework based on it.";
        $web_portfolio = new Project('Web Portfolio', '', 'https://github.com/IvaanTorres/portfolio-v1', 1, 1);
...
This project has been my first approach to Composition API with VueJS 3.";
        $smr_php_forum = new Project('PHP Forum', '', 'https://github.com/IvaanTorres/smr-php-forum', 1, 0);
